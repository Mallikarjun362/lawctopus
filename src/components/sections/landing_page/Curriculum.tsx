...
import { curriculum_full_v1 } from "./data/curriculum";
    ...
    <section className="py-24" id="curriculum">
      <div className="container mx-auto px-6">
        ...
        <div className="relative mt-10">
          <div className="bg-neutral-700 absolute top-10 bottom-60 left-6 hidden w-px md:block" />
          <div className="space-y-8">
            {curriculum_full_v1.map((item, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="bg-primary z-10 hidden mt-2 h-12 w-12 items-center justify-center rounded-full md:flex">
                  ...
                  <motion.div
                    whileHover={{ y: -4 }}
                    className="bg-background flex-1 rounded-3xl border p-6 sm:p-8 shadow-sm transition-all hover:shadow-lg"
                  >
                    ...
                    <div className="mt-2 sm:mt-6 grid gap-1 sm:gap-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                      {item.topics.map((topic) => (
                        <div key={topic} className="flex items-center gap-2">
                          <div className="h-2 w-2 rounded-full bg-orange-500" />
                          <span className="text-neutral-700 text-lg">{topic}</span>
                        </div>
                      ))}
                    </div>
                  </motion.div>
